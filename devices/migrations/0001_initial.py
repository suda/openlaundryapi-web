...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('devices_device', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='devices', to=orm['auth.User'])),
    ...
    models = {
        ...
        'devices.device': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'devices'", 'to': "orm['auth.User']"})
        }
    }
